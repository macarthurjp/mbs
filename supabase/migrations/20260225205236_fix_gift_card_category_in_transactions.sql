/*
  # Fix gift card creation to include required category
  
  1. Changes
    - Add category 'Gift Cards' to gift card sale transactions
    - Ensures all transactions have a valid category
*/

-- Drop existing function
DROP FUNCTION IF EXISTS create_gift_card(decimal, text, text, text, uuid, text);

-- Recreate with category included
