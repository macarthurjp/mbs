/*
  # Fix Timezone Conversion in Cashbox Functions (Corrected)
...
-- Function: Get Cashbox by Day (Correct timezone conversion)
...
BEGIN
  ...
  FROM transactions
  WHERE (created_at AT TIME ZONE 'America/Argentina/Buenos_Aires')::DATE < target_date;
...
-- Function: Get Cashbox by Period (Correct timezone conversion)
...
BEGIN
  ...
  FROM transactions
  WHERE (created_at AT TIME ZONE 'America/Argentina/Buenos_Aires')::DATE < start_date;
...
-- Function: Get Cashbox by Month (Correct timezone conversion)
...
-- Function: Get Cashbox by Year (Correct timezone conversion)
