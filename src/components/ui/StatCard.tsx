...
export function StatCard({
  ...
  return (
    <div className="group relative min-h-36 min-w-0 overflow-hidden rounded-[1.4rem] border border-[#e9e2d3] bg-white/95 p-4 shadow-[0_12px_40px_rgba(15,15,15,0.06)] transition-all duration-300 hover:-translate-y-1 hover:border-[#f4c542]/30 hover:shadow-[0_24px_60px_rgba(15,15,15,0.1)] sm:min-h-0 sm:rounded-[2rem] sm:p-6">
      ...
      <div className="relative z-10 flex min-w-0 items-start justify-between gap-3 sm:gap-4">
        ...
        <div
          className={`${iconColor} flex h-10 w-10 shrink-0 items-center justify-center rounded-xl border border-white/10 shadow-[0_18px_40px_rgba(15,15,15,0.14)] transition-all duration-300 group-hover:scale-105 group-hover:rotate-3 sm:h-14 sm:w-14 sm:rounded-[1rem] md:h-16 md:w-16 md:rounded-[1.4rem]`}
        >
          <Icon size={18} className="shrink-0 drop-shadow-sm sm:size-[24px] md:size-[28px]" />
        </div>
      </div>
    </div>
  );
