/*
  # Fix Edit Sale with Items - Search Path

  1. Changes
    - Fix search_path to include auth schema for proper auth.uid() resolution
    - This allows the function to work correctly with RLS policies
*/
