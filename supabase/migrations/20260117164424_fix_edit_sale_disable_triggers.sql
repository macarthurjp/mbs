/*
  # Fix Edit Sale - Disable Triggers During Edit

  1. Changes
    - Disable sync triggers temporarily during edit to prevent transaction deletion
    - Re-enable triggers after edit completes
*/
